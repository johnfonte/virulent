...
#define ENC_FLA INTF5	//encoder flag A
#define ENC_FLB INTF4	//encoder flag B
#define ENC_MSKA INT5	//encoder flag A
#define ENC_MSKB INT4	//encoder flag B
#define ENC_A 5			//encoder pin A
